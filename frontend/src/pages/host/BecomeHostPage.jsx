...
export default function BecomeHostPage() {
  ...
  function handleStart() {
    ...
    // Da dang nhap nhung khong phai tai khoan host — chua co API nang cap role,
    // dua ho di dang ky rieng 1 tai khoan host.
    navigate('/auth/register');
  }
          ...
          <div>
            ...
            {user && !isHost && (
              <p className="mt-3 text-sm text-neutral-500">
                Tài khoản hiện tại của bạn chưa phải tài khoản chủ nhà — bạn sẽ cần đăng ký 1 tài
                khoản chủ nhà riêng để đăng tin.
              </p>
            )}
          </div>
      ...
      <section className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 border-t border-neutral-200 pt-8">
          <button
            type="button"
            onClick={handleStart}
            className="rounded-lg bg-brand-600 px-6 py-3 text-base font-semibold text-white hover:bg-brand-700 transition-colors"
          >
            Bắt đầu
          </button>
          {!user && (
