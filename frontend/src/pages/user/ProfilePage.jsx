...
export default function ProfilePage() {
  ...
  useEffect(() => {
    if (profile) {
      setForm({ email: profile.email, fullName: profile.fullName, phone: profile.phone || '' });
    }
  }, [profile]);
  ...
  function handleProfileSubmit(e) {
    e.preventDefault();
    updateProfile.mutate({ email: form.email, fullName: form.fullName, phone: form.phone });
  }
