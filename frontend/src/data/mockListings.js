...
// bookedRanges: mảng [{ start: 'YYYY-MM-DD', end: 'YYYY-MM-DD' }] (end exclusive)
const BOOKED_RANGES = {
  'mock-1': [{ start: '2026-08-10', end: '2026-08-14' }, { start: '2026-08-20', end: '2026-08-23' }, { start: '2026-09-05', end: '2026-09-09' }],
  'mock-2': [{ start: '2026-08-08', end: '2026-08-11' }, { start: '2026-08-25', end: '2026-08-28' }, { start: '2026-09-12', end: '2026-09-16' }],
  'mock-3': [{ start: '2026-08-15', end: '2026-08-20' }, { start: '2026-09-01', end: '2026-09-05' }],
  'mock-4': [{ start: '2026-08-09', end: '2026-08-12' }, { start: '2026-08-18', end: '2026-08-22' }, { start: '2026-09-08', end: '2026-09-12' }],
  'mock-5': [{ start: '2026-08-12', end: '2026-08-17' }, { start: '2026-09-03', end: '2026-09-07' }],
  'mock-6': [{ start: '2026-08-11', end: '2026-08-14' }, { start: '2026-08-28', end: '2026-09-02' }],
  'mock-7': [{ start: '2026-08-07', end: '2026-08-09' }, { start: '2026-08-16', end: '2026-08-21' }, { start: '2026-09-10', end: '2026-09-15' }],
  'mock-8': [{ start: '2026-08-13', end: '2026-08-19' }, { start: '2026-09-06', end: '2026-09-11' }],
};

export function getListingById(id) {
  const listing = mockListings.find((l) => l.id === id);
  if (!listing) return null;
  return { ...listing, images: gallery(listing.image), bookedRanges: BOOKED_RANGES[id] ?? [] };
}
